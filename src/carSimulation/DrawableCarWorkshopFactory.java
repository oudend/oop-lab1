...
public class DrawableCarWorkshopFactory {
    public static DrawableCarWorkshop createVolvo240Workshop(int maxCars, Point2D.Double point) throws IOException {
        return new DrawableCarWorkshop(new CarWorkshop<Volvo240>(maxCars, point.getX(), point.getY()), ImageIO.read(DrawPanel.class.getResourceAsStream("pics/VolvoBrand.jpg")));
    }
}
