...
public class DrawableCarFactory {
    ...
    public static DrawableCar createSaab95(Point2D point) throws IOException {
        return new DrawableCar(new Volvo240(point.getX(), point.getY()), ImageIO.read(DrawPanel.class.getResourceAsStream("pics/Saab95.jpg")));
    }

    public static DrawableCar createScania(Point2D point) throws IOException {
        return new DrawableCar(new Volvo240(point.getX(), point.getY()), ImageIO.read(DrawPanel.class.getResourceAsStream("pics/Scania.jpg")));
    }
}
